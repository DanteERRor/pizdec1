...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
#define PID_DUTY_CYCLE_MIN                                          27115 // 5000 - минимальный Ш�?М
#define PID_DUTY_CYCLE_MAX                                          27115 // 65535 - максимальный Ш�?М
...
float pwmDutyCycle = 0; // начальный Ш�?М
...
float targetSpeed = 6250; // Необходимая скорость
